...
const DATA_BRAND_MODEL = [
  ...
  { id: 2,name: "Hyundai",  type:"car",
      models: [{"id":1,"name":"Accent"},{"id":11,"name":"Click"},{"id":2,"name":"Elantra"},{"id":3,"name":"Genesis"},{"id":12,"name":"Getz"},{"id":4,"name":"i10"},{"id":5,"name":"Kona"},{"id":6,"name":"SantaFe"},{"id":7,"name":"Solati"},
      ...
      Message: {
        Body: {
          Html: {
            Charset: 'UTF-8',
            Data:
            "<h3>Xin Chào "+newRecovery.email+".</h3>" + 
